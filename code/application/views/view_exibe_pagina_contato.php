	...
	<div class="post clearfix" id="sobre-nos">
		...
		<div class="post-wrapper">
			...
			<?php 
				...
				$campos_hidden = array('contact_type'=>'contato');
			...
			<div class="row form-name">
				...
				?>
				<div class="clear"></div>
				<span class="contact_error" id="email_error">* Digite um email válido</span>
			</div>
			...
			<div class="row form-comment">
				...
				?>
				<div class="clear"></div>
				<span class="contact_error" id="message_error">* O que você quer nos dizer?</span>
			</div>
			...
			<p id="cf_submit_p">
				<?php echo form_submit('btn_cadastro', 'Enviar Mensagem', 'id="send_message" class="button"'); ?>
			</p>
