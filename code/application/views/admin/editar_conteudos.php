<div id="content">
	<?php 
		...
		echo heading('Editar conteúdo - 1° Passo ' . img(base_url('assets/images/novo.gif')), 2, 'class="divisor"');
		...
		echo form_open('admin/conteudos/adicionar', $data, $hidden);			
			...
			$data = array('name' => 'titulo', 'id' => 'titulo', 'value' => $conteudo->titulo);
			echo form_input($data);
			
			echo form_label('Slug', 'slug');
			$data = array('name' => 'slug', 'id' => 'slug', 'value' => $conteudo->slug);
			echo form_input($data);

			echo '<p>';
			echo '<span>';
			echo form_label('Pertence à', 'id_categoria');
			echo form_dropdown('id_categoria', $array_categorias, $conteudo->id_categoria, 'class="input_md"');
			echo '</span>';
			...
			$data = array('name' => 'ordem', 'id' => 'ordem', 'value' => $conteudo->ordem, 'style' => 'width: 50px; margin-left: 20px; margin-right: 4px;');
			echo form_input($data);
			echo '</span>';
			echo '</p>';
			
			echo form_label('Descrição', 'descricao');
			$data = array('name' => 'descricao', 'id' => 'descricao', 'value' => $conteudo->descricao);
