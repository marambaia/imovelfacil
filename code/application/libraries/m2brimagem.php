...
class m2brimagem {
	 ...
	 * @return void
	*/
	public function initialize( $origem = '', $extensoes_validas = array( 'jpg', 'jpeg', 'jpe', 'gif', 'bmp', 'png' ) ) 
	{
		$this->origem					= $origem;
...
// --------------------------------------------------------------------
	...
	/**
	 *
	 * Reseta valores no caso desta classe ser usada em um loop
	 *
	 * @access	public
	 * @return	void
	 */
	...
	{	
		$props = array('origem', 'img', 'img_temp', 'largura', 'altura', 'nova_largura', 'nova_altura', 'tamanho_html', 'formato', 'extensao', 'tamanho', 'arquivo', 'diretorio', 'extensoes_validas', 'rgb', 'posicao_crop', 'erro');
